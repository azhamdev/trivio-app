      ...
      <FadeSlideIn>
        <View style={styles.headerRow}>
          <View style={styles.headerText}>
            ...
            <Text style={styles.headerCaption}>Let&apos;s keep the trip on budget.</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  headerText: { flex: 1 },
  headerCaption: { ...type.caption, fontSize: 13.5, marginTop: 4 },
  actionsRow: { flexDirection: 'row', gap: 12, marginTop: 24 },
  actionBtn: { flex: 1 },
  sectionLabel: { ...type.overline, marginTop: 32, marginBottom: 14 },
});
